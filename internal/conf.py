...
# Lemonfold.io build configuration file, created by
# `ablog start` on Wed Aug  3 00:43:43 2022.
#
...
blog_title = "Lemonfold.io Blog"

# Base URL for the website, required for generating feeds.
# e.g. blog_baseurl = "http://example.com/"
blog_baseurl = "internal.lemonfold.io"
...
html_sidebars = {
    "index": ["who.html"],
    "about": ["who.html"],
    "publications": ["who.html"],
    "projects": ["who.html"],
    # "index": ["search-field.html", "who.html"],
    # "about": ["search-field.html", "who.html"],
    # "publications": ["search-field.html", "who.html"],
    # "projects": ["search-field.html", "who.html"],
    "posts/**": [
        "search-field.html",
        "postcard.html",
        "recentposts.html",
    ...
    "blog": ["search-field.html", "tagcloud.html", "archives.html"],
    "blog/**": [
        "search-field.html",
        "postcard.html",
        "recentposts.html",
...
bibtex_bibfiles = ["_static/Last.bib"]
...
class LemonfoldStyle(Style):
    ...
    def get_patent_template(self, e):
        ...
        template = toplevel [
            ...
            sentence [
                tag('em') [
                    field('type',apply_func=lambda x: type_dict[x.plaintext()]),
                    field('number')
                ],
                field('holder'),
...
pybtex.plugin.register_plugin(
    "pybtex.style.formatting", "lemonfold_style", LemonfoldStyle
)
pybtex.plugin.register_plugin(
    "pybtex.style.sorting", "lemonfold_sorting_style", LemonfoldSortingStyle
)


bibtex_bibfiles = ["../LaTeX/Bewerbungen/Last.bib"]
bibtex_reference_style = "label"
bibtex_default_style = "lemonfold_style"
...
html_theme_options = {
    ...
    # "github_url": "https://github.com/FirstLast/",
    # "twitter_url": "https://twitter.com/choldgraf",
    "search_bar_text": "Search this site...",
    # "google_analytics_id": "UA-236840048-1",
    # "google_analytics_id": "G-326325775",
    "navbar_end": ["theme-switcher", "cookies", "navbar-icon-links"],
    # "navbar_end": ["search-field.html", "theme-switcher", "navbar-icon-links"],
    # "analytics": {
    #     "plausible_analytics_domain": "lemonfold.io",
    #     "plausible_analytics_url": "https://analytics.lemonfold.io/js/plausible.js",
    # },
}
...
htmlhelp_basename = "Lemonfoldiodoc"
